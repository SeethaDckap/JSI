...
class Orders implements OrderFieldsInterface
{
    ...
    public function getFields()
    {
        ...
        $extensionAttributes = $this->config->get(\Magento\Sales\Api\Data\OrderInterface::class);
        ...
        $itemExtensionAttributes = $this->config->get(\Magento\Sales\Api\Data\OrderItemInterface::class);
        ...
        $addressAttributes = $this->config->get(
        ...
        $extensionAttributes = [];
        $extensionAttributes = $this->config->get(

...
class ProductIndex implements ProductIndexRepositoryInterface
{
    ...
    private $productIndexInterfaceFactory;
     ...
     * @param ProductIndexInterfaceFactory $productIndexInterfaceFactory
     */
     ...
     * @param string $urlKey
     */
    public function isProductUrlExists($urlKey)
    {
        $productsIndex = $this->productIndexCollection->create();
        return $productsIndex->isUrlExists($urlKey);
    }
}//end class

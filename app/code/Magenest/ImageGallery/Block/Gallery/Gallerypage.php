...
class Gallerypage extends Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        //$this->pageConfig->getTitle()->set(__('Cabinspiration'));
    ...
    public function getAllImageFromGalleries()
    {
        ...
        if ($gallery_id == null || $gallery_id == 0)
        {
            ...
            for ($i = 0; $i < sizeof($list_image_all); $i++)
            {
                ...
                $this->loadedImage[$imageModel->getData('image_id')] = [
                    ...
                    'image_size_factor' => $imageModel->getData('image_size_factor'),
            ...
            foreach ($list_image_all as $image) {
                ...
                $list_all[] = [
                    ...
                    'image_size_factor' => $this->loadedImage[$image]['image_size_factor'],
        ...
        foreach ($list_image as $image)
        {
            ...
            $list[] = [
                ...
                'image_size_factor' => $this->loadedImage[$image['image_id']]['image_size_factor'],

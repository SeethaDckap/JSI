...
class Rules extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function __construct(
        ...
        \Epicor\AccessRight\Model\ResourceModel\Rules $resource,
        \Epicor\AccessRight\Model\ResourceModel\Rules\Collection $resourceCollection,
        array $data = []
    ) {
    ...
    {
        $this->_init(\Epicor\AccessRight\Model\ResourceModel\Rules::class);
    }

...
class Renderer extends \Magento\Framework\View\Element\Html\Select
{
    ...
    public function setColumnName($value)
    {
        ...
        return $this->setExtraParams('rel="<%- renderer %>" style="width:50px"');
    ...
    public function _toHtml()
    {
        if (!$this->getOptions()) {
            ...
            $this->addOption('Epicor_Customerconnect_Block_List_Renderer_Rmastatus', __('RMA status'));
            $this->addOption('Epicor_Customerconnect_Block_List_Renderer_Linkinvoice', __('Invoice Link'));
        }

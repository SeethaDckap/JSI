 ...
 */
namespace Epicor\Comm\Block\Adminhtml\Customer\AllowedCustomer;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $customerTypes = array();
        if(isset($data['notAllowedCustomerTypes']) && !empty($data['notAllowedCustomerTypes'])){

            $customerTypes = explode("||",$data['notAllowedCustomerTypes']);
        }
        ...
        if(!empty($customerTypes)) {
            $collection->addAttributeToFilter('ecc_erp_account_type', array('nin' => array($customerTypes)));
        }
    ...
    public function getGridUrl()
    {
        ...
        if(isset($data['notAllowedCustomerTypes']) && !empty($data['notAllowedCustomerTypes'])){
            ...
            return $this->getUrl('*/*/*', array('grid' => true, 'field_id' => $data['field_id'],
                'notAllowedCustomerTypes' => $data['notAllowedCustomerTypes']));
        }

 ...
 */
namespace Epicor\Comm\Block\Adminhtml\Customer\Erpaccount\Allowedaccounts;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function addAccountTypeFilter(&$collection, $fieldName)
    {
        ...
        $data = $this->getRequest()->getParams();
        if(isset($data['allowedAccountTypes']) && !empty($data['allowedAccountTypes'])){

            $types=explode("||",$data['allowedAccountTypes']);
        }
    ...
    public function getGridUrl()
    {
        ...
        return $this->getUrl('*/*/*', array('grid' => true, 'field_id' => $data['field_id'],
            'allowedAccountTypes' => $data['allowedAccountTypes']));
    }

...
class AllowedErpaccounts extends \Magento\Framework\Data\Form\Element\AbstractElement
{

    protected $_types;
    protected $_accountType;
    protected $_restrictToType = '';
    protected $_allowedAccountTypes = [];
        ...
        array $data = [])
    {
        ...
        $this->_allowedAccountTypes = $this->getData('allowedAccountTypes');
        $this->_restrictToType = 'allcustomer';
    ...
    public function getElementHtml()
    {
        ...
        $types['allcustomer'] = 	[
            'label' => 'Customer',
            'field' => 'ecc_erpaccount_id',
            'model' => 'epicor_comm/customer_erpaccount',
            'url' => 'adminhtml/epicorcomm_customer_erpaccount/allowedaccounts/',
            'priority' => '0',
        ];
    ...
    {
        $params =[];
        if(!empty($this->_allowedAccountTypes)){
            $allowedAccounts=implode("||",$this->_allowedAccountTypes);
            $params['allowedAccountTypes']=$allowedAccounts;
        }

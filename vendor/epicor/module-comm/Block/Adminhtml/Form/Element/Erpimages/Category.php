 ...
 */
namespace Epicor\Comm\Block\Adminhtml\Form\Element\Erpimages;
 ...
 */
class Category extends \Epicor\Common\Lib\Varien\Data\Form\Element\Serialized
{
    protected  $_data_form_part = 'category_form'; 
   ...
   protected function getFooter()
    {
        $disabled = '';
        if (count($this->getRowData()) == 0) {
            $disabled = ' class="disabled" disabled="disabled"';
        }

        return '<button type="button" title="Sync Images" onclick="syncFtpImages()"' . $disabled . '>Sync Images</button>';
    } */

...
class Customersgrid extends \Epicor\Comm\Controller\Adminhtml\Epicorcomm\Locations
{
    ...
    public function execute()
    {
        ...
        $stores = $this->getRequest()->getParam('customers');
        $this->_registry->register('location', $location);
        $resultLayout = $this->_resultLayoutFactory->create();
        $resultLayout->getLayout()->getBlock('customers_grid')
            ->setSelected($stores);
        return $resultLayout;
    }

...
class Stores extends \Epicor\Comm\Controller\Adminhtml\Epicorcomm\Locations
{
    ...
    public function execute()
    {
        ...
        $resultLayout->getLayout()->getBlock('stores_grid')
            ->setSelected($this->getRequest()->getPostValue('stores', null));
        return $resultLayout;
    }

...
class SaveLines extends \Epicor\Comm\Controller\Returns
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($return && !$return->isObjectNew()) {
                ...
                $errors[] = __('Failed to find return to add lines to. Please try again.');
            }

            $subStep = !empty($errors) ? 'lines' : false;
            $this->registry->register('response_json', $this->sendStepResponse('products', $errors, true, $subStep));

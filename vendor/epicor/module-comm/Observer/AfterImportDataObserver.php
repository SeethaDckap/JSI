 ...
 * This Oberver was rewite to use for New stk Import
 * If customer has multi website product visibility should be not-visiable and url has to be generate
 *
...
class AfterImportDataObserver implements ObserverInterface
{
    ...
    {
        //if you have multi store we have to save product even product is not visiable

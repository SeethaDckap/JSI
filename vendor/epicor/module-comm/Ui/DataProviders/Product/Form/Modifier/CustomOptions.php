...
class CustomOptions extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\CustomOptions
{
    ...
    const FIELD_ECC_CODE_NAME = 'ecc_code';
    const FIELD_ECC_VALIDATION_CODE_NAME = 'ecc_validation_code';
    const FIELD_ECC_DEFAULT_VALUE_NAME = 'ecc_default_value';
    ...
    protected function getStaticTypeContainerConfig($sortOrder)
    {
        return [
            ...
            'children' => [
                ...
                static::FIELD_ECC_CODE_NAME => $this->getEccCodeFieldConfig(30),
                static::FIELD_ECC_VALIDATION_CODE_NAME => $this->getEpicorValadtionFieldConfig(42),
                static::FIELD_ECC_DEFAULT_VALUE_NAME => $this->getEccDefaultValueFieldConfig(44)
            ]
        ];
    }
                ...
                'data' => [
                    'config' => [
                        ...
                        'groupsConfig' => [
                            ...
                            'ecc_text' => [
                                'values' => ['ecc_text_field'],
                                'indexes' => [
                                    static::CONTAINER_TYPE_STATIC_NAME,
                                    static::FIELD_ECC_CODE_NAME,
                                    static::FIELD_SKU_NAME,
                                    static::FIELD_MAX_CHARACTERS_NAME,
                                    static::FIELD_ECC_VALIDATION_CODE_NAME,
                                    static::FIELD_ECC_DEFAULT_VALUE_NAME
                                ]
                            ]
                        ],
                    ],
    ...
    /**
     * Get config for "Epicore Code" field
     *
     * @param int $sortOrder
     * @return array
     */
    protected function getEccCodeFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'componentType' => Field::NAME,
                        'formElement' => Input::NAME,
                        'dataScope' => static::FIELD_ECC_CODE_NAME,
                        'dataType' => Text::NAME,
                        'sortOrder' => $sortOrder,
                    ],
                ],
     ...
     * @return array
     */
    protected function getEpicorValadtionFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        'label' => __('Validation Code'),
                        'componentType' => Field::NAME,
                        'formElement' => Input::NAME,
                        'dataScope' => static::FIELD_ECC_VALIDATION_CODE_NAME,
                        'dataType' => Text::NAME,
                        'sortOrder' => $sortOrder,
                    ],
                ],
     ...
     * @return array
     */
    protected function getEccDefaultValueFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'componentType' => Field::NAME,
                        'formElement' => Input::NAME,
                        'dataScope' => static::FIELD_ECC_DEFAULT_VALUE_NAME,
                        'dataType' => Text::NAME,
                        'sortOrder' => $sortOrder,
                    ],
                ],

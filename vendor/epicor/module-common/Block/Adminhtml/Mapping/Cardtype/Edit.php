...
class Edit extends \Epicor\Common\Block\Adminhtml\Mapping\DefaultBlock\Edit
{
    ...
    {
        if ($this->registry->registry('cardtype_mapping_data') && $this->registry->registry('cardtype_mapping_data')->getMagentoId()) {
            $title = $this->registry->registry('cardtype_mapping_data')->getMagentoId();

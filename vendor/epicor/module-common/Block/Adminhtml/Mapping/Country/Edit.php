...
//            'onclick' => 'saveAndContinueEdit()',
    ...
    {
        if ($this->registry->registry('country_mapping_data') && $this->registry->registry('country_mapping_data')->getMagentoId()) {
            $title = $this->registry->registry('country_mapping_data')->getMagentoId();
            //M1 > M2 Translation Begin (Rule p2-6.4)
            //$title = Mage::app()->getLocale()->getCountryTranslation($title);
            $title = $this->_localeResolver->getLocale()->getCountryTranslation($title);
            //M1 > M2 Translation End

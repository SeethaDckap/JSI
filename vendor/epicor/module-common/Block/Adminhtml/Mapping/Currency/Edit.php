...
//            'onclick' => 'saveAndContinueEdit()',
    ...
    {
        if ($this->registry->registry('currency_mapping_data') && $this->registry->registry('currency_mapping_data')->getMagentoId()) {
            $title = $this->registry->registry('currency_mapping_data')->getMagentoId();

...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->registry->registry('erporderstatus_mapping_data') && $this->registry->registry('erporderstatus_mapping_data')->getCode()) {
            $title = $this->registry->registry('erporderstatus_mapping_data')->getCode();

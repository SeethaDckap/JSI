...
class Edit extends \Epicor\Common\Block\Adminhtml\Mapping\DefaultBlock\Edit
{
    ...
    {
        if ($this->registry->registry('invoicestatus_mapping_data') && $this->registry->registry('invoicestatus_mapping_data')->getCode()) {
            $title = $this->registry->registry('invoicestatus_mapping_data')->getCode();

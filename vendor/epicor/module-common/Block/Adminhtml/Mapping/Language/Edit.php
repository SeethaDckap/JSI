...
//            'onclick' => 'saveAndContinueEdit()',
    ...
    {
        if ($this->registry->registry('language_mapping_data') && $this->registry->registry('language_mapping_data')->getMagentoId()) {
            $title = $this->registry->registry('language_mapping_data')->getMagentoId();
            //M1 > M2 Translation Begin (Rule p2-6.4)
            //$title = Mage::app()->getLocale()->getLanguageTranslation($title);
            $title = $this->_localeResolver->getLocale()->getLanguageTranslation($title);
            //M1 > M2 Translation End

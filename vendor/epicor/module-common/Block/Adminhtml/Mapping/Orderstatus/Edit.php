...
//            'onclick' => 'saveAndContinueEdit()',
    ...
    {
        if ($this->registry->registry('orderstatus_mapping_data') && $this->registry->registry('orderstatus_mapping_data')->getCode()) {
            $title = $this->registry->registry('orderstatus_mapping_data')->getCode();

...
//            'onclick' => 'saveAndContinueEdit()',
    ...
    {
        if ($this->registry->registry('payment_mapping_data') && $this->registry->registry('payment_mapping_data')->getMagentoCode()) {
            $title = $this->registry->registry('payment_mapping_data')->getMagentoCode();

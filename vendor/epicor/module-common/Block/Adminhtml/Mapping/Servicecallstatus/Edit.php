...
class Edit extends \Epicor\Common\Block\Adminhtml\Mapping\DefaultBlock\Edit
{
        ...
        array $data)
    {
        ...
        $this->_objectId = 'id';
        $this->_controller = 'adminhtml\Mapping_Servicecallstatus';
    ...
    {
        if ($this->registry->registry('servicecallstatus_mapping_data') && $this->registry->registry('servicecallstatus_mapping_data')->getCode()) {
            $title = $this->registry->registry('servicecallstatus_mapping_data')->getCode();

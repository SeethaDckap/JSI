...
//            'onclick' => 'saveAndContinueEdit()',
    ...
    {
        if ($this->registry->registry('shippingmethods_mapping_data') && $this->registry->registry('shippingmethods_mapping_data')->getCode()) {
            $title = $this->registry->registry('shippingmethods_mapping_data')->getShippingMethod();

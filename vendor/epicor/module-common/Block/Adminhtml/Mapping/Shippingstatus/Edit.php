...
class Edit extends \Epicor\Common\Block\Adminhtml\Mapping\DefaultBlock\Edit
{
        ...
        array $data)
    {
        ...
        $this->_objectId = 'id';
        $this->_controller = 'adminhtml_mapping_shippingstatus';
...
//            'onclick' => 'saveAndContinueEdit()',
    ...
    {
        if ($this->registry->registry('shippingstatus_mapping_data') && $this->registry->registry('shippingstatus_mapping_data')->getCode()) {
            $title = $this->registry->registry('shippingstatus_mapping_data')->getShippingMethod();

...
class ExportXml extends \Epicor\Common\Controller\Adminhtml\Epicorcommon\Mapping\Erporderstatus
{
    ...
    public function execute()
    {
        ...
        $exportBlock = $this->_view->getLayout()->createBlock('Epicor\Common\Block\Adminhtml\Mapping\Erporderstatus\Grid');

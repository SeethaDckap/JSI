...
class ExportXml extends \Epicor\Common\Controller\Adminhtml\Epicorcommon\Mapping\Language
{
    ...
    public function execute()
    {
        ...
        $exportBlock = $this->_view->getLayout()->createBlock('Epicor\Common\Block\Adminhtml\Mapping\Language\Grid');

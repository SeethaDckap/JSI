...
class ExportCsv extends \Epicor\Common\Controller\Adminhtml\Epicorcommon\Mapping\Shippingmethods
{
...
public function execute()
    {
        ...
        $exportBlock = $this->_view->getLayout()->createBlock('Epicor\Common\Block\Adminhtml\Mapping\Shippingmethods\Grid');

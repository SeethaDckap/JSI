...
namespace Epicor\Customerconnect\Block\Adminhtml\Config\Form\Field\Cuid;
...
class InformationLayout extends \Epicor\Common\Block\Adminhtml\Config\Form\Field\InformationLayout
{
    ...
    protected function _renderValue(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $html .= '<table cellpadding="2" cellspacing="4" style="border: 1px solid burlywood;padding-bottom:6px;margin-top: 25px;border-collapse: separate;border-radius: 5px;background: oldlace;"><tr><td>'

...
class Renderer extends \Magento\Framework\View\Element\Html\Select
{
    ...
    public function _toHtml()
    {
        if (!$this->getOptions()) {
            ...
            $this->addOption('Epicor_Customerconnect_Block_List_Renderer_Additionalreference',  __('Additional Reference'));
            $this->addOption('Epicor_Customerconnect_Block_List_Renderer_Requireddate',  __('Required date'));
        }

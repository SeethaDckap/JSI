 ...
 */
namespace Epicor\Customerconnect\Block\Customer\Account\Balances\Aged;
...
class Listing extends \Epicor\Common\Block\Generic\Listing
{
    ...
    const FRONTEND_RESOURCE = 'Epicor_Customerconnect::customerconnect_account_information_aged_balances_read';
    /**
    ...
    {
        $this->_controller = 'customer_account_balances_aged_listing';

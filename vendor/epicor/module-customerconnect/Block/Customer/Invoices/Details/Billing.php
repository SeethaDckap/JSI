...
class Billing extends \Epicor\Customerconnect\Block\Customer\Address
{

    const FRONTEND_RESOURCE_BILLING_READ = 'Epicor_Customerconnect::customerconnect_account_invoices_details';

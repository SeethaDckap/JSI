...
class Grid extends \Epicor\Common\Block\Generic\Listing\Grid
{
    ...
    protected function getLineData()
    {
        ...
        if ($rfq) {
            ...
            foreach ($linesData as $row) {
                ...
                $row->setMiscLineTotal($row->getLineValue() + $row->getMiscellaneousChargesTotal());
                $lines[] = $row;
            }
    ...
    protected function _getColumns()
    {
        ...
        $columns['attachments'] = array(
            ...
            'align' => 'left',
            'index' => 'attachments',
            'renderer' => 'Epicor\Customerconnect\Block\Customer\Rfqs\Details\Lines\Renderer\Attachments',
            'type' => 'text',
            'filter' => false,
            'keep_data_format' => 1,

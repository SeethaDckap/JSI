 ...
 */
class DealerAttachments extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        if (count($miscellaneousCharges) > 0 && $showMiscCharges) {
            $html .= '<tr class="lines_row attachment" id="row-misc-' . $row->getUniqueId() . '" style=' . $defDisplay . '><td colspan='.$colspan.' class="">
        ...
        $block = $this->getLayout()->createBlock('Epicor\Customerconnect\Block\Customer\Rfqs\Details\Lines\Attachments');

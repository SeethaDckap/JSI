...
namespace Epicor\Customerconnect\Block\Customer\Rmas\Listing\Renderer;
...
class Reorder extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Input
{
    ...
    private function isPreqActive()
    {
        return $this->_scopeConfig->getValue('customerconnect_enabled_messages/PREQ_request/active');
    }
    ...
    private function getPrintAction($row)
    {
        return $this->getLayout()
            ...
            ->setData('entity_key', $row->getData('returns_number'))
            ->setData('entity_document', 'RMA')

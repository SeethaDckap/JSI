...
class Edit extends \Epicor\Customerconnect\Controller\Adminhtml\Epicorcommon\Mapping\Miscellaneouscharges
{
    ...
    public function execute()
    {
        ...
        $this->_registry->register('misc_mapping_data', $model);

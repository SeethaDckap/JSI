...
use Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Address\Collection;
use Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Item\Collection as ImportCollection;
use Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\Collection as PaymentCollection;
use Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Status\History\Collection as HistoryCollection;
 ...
 * @method \Epicor\Customerconnect\Model\ArPayment\Order setGiftMessageId(int $value)
 * @method bool hasBillingAddressId()
 * @method \Epicor\Customerconnect\Model\ArPayment\Order unsBillingAddressId()
 * @method bool hasShippingAddressId()
 * @method \Epicor\Customerconnect\Model\ArPayment\Order unsShippingAddressId()
 ...
 * @method \Epicor\Customerconnect\Model\ArPayment\Order setSendEmail(bool $value)
 ...
 * @since 100.0.2
 */
class Order extends \Epicor\Customerconnect\Model\ArPayment\AbstractModel implements \Epicor\Customerconnect\Api\Data\OrderInterface
{
    const ENTITY = 'order';
    ...
    // Template path for AR PAYMENTS EMAIL
    const XML_PATH_ARPAYMENTS_EMAIL_TEMPLATE='ecc_arpayment_email_template';

    /**
     * @var string
     */
    protected $_eventPrefix = 'ecc_ar_sales_order';
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\Order\Config
     */
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Item\CollectionFactory
     */
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\Order\Status\HistoryFactory
     */
    protected $_orderHistoryFactory;

    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Address\CollectionFactory
     */
    protected $_addressCollectionFactory;

    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\CollectionFactory
     */
    protected $_paymentCollectionFactory;

    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Status\History\CollectionFactory
     */
    protected $_historyCollectionFactory;

    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\CollectionFactory
     */
     ...
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Item\CollectionFactory $orderItemCollectionFactory
     * @param \Magento\Catalog\Model\Product\Visibility $productVisibility
     * @param \Magento\Directory\Model\CurrencyFactory $currencyFactory
     * @param \Magento\Eav\Model\Config $eavConfig
     * @param Order\Status\HistoryFactory $orderHistoryFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Address\CollectionFactory $addressCollectionFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\CollectionFactory $paymentCollectionFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Status\History\CollectionFactory $historyCollectionFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Invoice\CollectionFactory $invoiceCollectionFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Shipment\CollectionFactory $shipmentCollectionFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Creditmemo\CollectionFactory $memoCollectionFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Shipment\Track\CollectionFactory $trackCollectionFactory
    ...
    public function __construct(
        ...
        \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Item\CollectionFactory $orderItemCollectionFactory,
        ...
        \Epicor\Customerconnect\Model\ArPayment\Order\Status\HistoryFactory $orderHistoryFactory,
        \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Address\CollectionFactory $addressCollectionFactory,
        \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\CollectionFactory $paymentCollectionFactory,
        \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Status\History\CollectionFactory $historyCollectionFactory,
        \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\CollectionFactory $salesOrderCollectionFactory,
    ...
    {
        $this->_init(\Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order::class);
    }
    ...
    {
        /** @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Collection $salesOrderCollection */
     ...
     *
     * @return \Epicor\Customerconnect\Model\ArPayment\Order\Config
     */
     ...
     *
     * @param \Epicor\Customerconnect\Api\Data\OrderAddressInterface $address
     * @return $this
     */
    public function setBillingAddress(\Epicor\Customerconnect\Api\Data\OrderAddressInterface $address = null)
    {
     ...
     * @return $this
     */
    public function setShippingAddress(\Epicor\Customerconnect\Api\Data\OrderAddressInterface $address = null)
    {
     ...
     *
     * @return \Epicor\Customerconnect\Api\Data\OrderAddressInterface|null
     */
     ...
     *
     * @return \Epicor\Customerconnect\Model\ArPayment\Order\Address|null
     */
    ...
    {
        $this->_eventManager->dispatch('ecc_ar_sales_order_place_before', ['order' => $this]);
        $this->_placePayment();
        $this->_eventManager->dispatch('ecc_ar_sales_order_place_after', ['order' => $this]);
        return $this;
    }
    ...
    public function cancel()
    {
        if ($this->canCancel()) {
            ...
            $this->_eventManager->dispatch('ar_order_cancel_after', ['order' => $this]);
        }
    ...
    /**
     * @param \Epicor\Customerconnect\Model\ArPayment\Order\Address $address
     * @return $this
     */
    public function addAddress(\Epicor\Customerconnect\Model\ArPayment\Order\Address $address)
    {
    ...
    /**
     * @return \Epicor\Customerconnect\Model\ArPayment\Order\Item[]
     */
    ...
    /**
     * @param \Epicor\Customerconnect\Model\ArPayment\Order\Item $item
     * @return $this
     */
    public function addItem(\Epicor\Customerconnect\Model\ArPayment\Order\Item $item)
    {
        $item->setOrder($this);
        if (!$item->getId()) {
     ...
     * {@inheritdoc}
     */
    public function setPayment(\Epicor\Customerconnect\Api\Data\OrderPaymentInterface $payment = null)
    {
     ...
     *
     * @param \Epicor\Customerconnect\Model\ArPayment\Order\Status\History $history
     * @return $this
     */
    public function addStatusHistory(\Epicor\Customerconnect\Model\ArPayment\Order\Status\History $history)
    {
    ...
    public function getRealOrderId()
    {
        ...
        if ($helper->showBothOrderNumbers($this)) {
            ...
            if ($this->getErpArpaymentsOrderNumber()) {
                //M1 > M2 Translation Begin (Rule 55)
                //$orderNumber .= $helper->__(' (ERP #%s)', $this->getEccErpOrderNumber());
                $orderNumber .= __(' (ERP #%1)', $this->getErpArpaymentsOrderNumber());
                //M1 > M2 Translation End
            }
        } elseif ($helper->showErpOrderNumberOnly($this)) {
            $orderNumber = $this->getErpArpaymentsOrderNumber();
        } else {
            $orderNumber = $this->getIncrementId();
        }
        return $orderNumber;
    ...
    public function getArpaymentsRealOrderId() {
         $helper = $this->commSalesOrderHelper;
        /* @var $helper Epicor_Comm_Helper_Sales_Order */

        if ($helper->showBothArpaymentsNumbers($this)) {
            $orderNumber = $this->getIncrementId();
            if ($this->getErpArpaymentsOrderNumber()) {
                $orderNumber .=  __(' (ERP #%1)', $this->getErpArpaymentsOrderNumber());
            }
        } elseif ($helper->showErpArpaymentsNumberOnly($this)) {
            $orderNumber = $this->getErpArpaymentsOrderNumber();
        } else {
            $orderNumber = $this->getIncrementId();
        }
     ...
     *
     * @param array $qtys
     * @return \Epicor\Customerconnect\Model\ArPayment\Order\Invoice
     */
    ...
    public function createIncrementId($order)
    {
        $prefix = $this->scopeConfig->getValue('customerconnect_enabled_messages/CAAP_request/prefix', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStoreId());
        $result = $prefix;
        $result .= str_pad($order->getId(), 10, '0', STR_PAD_LEFT);
        return $result;
    }

    public function createOrder(\Epicor\Customerconnect\Api\Data\OrderInterface $entity)
    {
        $entity->save();
        $entity->getShippingAddress()->save();
        $entity->getBillingAddress()->save();
        $entity->getPayment()->save();
        foreach ($entity->getAllItems() as $item) {
             $item->setOrderId($entity->getId());
             $item->save();
        }
        $increment_id = $this->createIncrementId($entity);
        $entity->setIncrementId($increment_id);
        $entity->setShippingAddressId($entity->getShippingAddress()->getId());
        $entity->setBillingAddressId($entity->getBillingAddress()->getId());
        $entity->setIsInProcess(true);
        $entity->save();
        $this->addTransaction($entity);
        $paymentMethod = $entity->getPayment();
       ...
       $quote = $this->checkoutSession->getQuote();
        ...
        $this->sendEmail($paymentMethod);
        return $entity;
    }

    public function sendEmail($paymentMethod)
    {
      try {
        if (substr_count($paymentMethod->getMethod(), 'klarna_') > 0) {
           $paymentMethods = $this->paymentHelper->getMethodInstance($paymentMethod->getMethod());
           $paymentBlockHtml = $paymentMethods->getTitle();
        } else {
           $paymentBlockHtml =  $this->getPaymentHtml();
        }
        $templateParams = ['order' => $this,
            'billing'      => $this->getBillingAddress(),
            'formattedBillingAddress' => $this->addressRenderer->format($this->getBillingAddress(), 'html'),
       ...
       $sendMailSuccess = $this->commonHelper
               ->sendTransactionalEmailWithResponse(
                    self::XML_PATH_ARPAYMENTS_EMAIL_TEMPLATE,
                    $from,
    ...
    public function addTransaction(\Epicor\Customerconnect\Api\Data\OrderInterface $order)
    {
        $method = $order->getPayment()->getMethodInstance();
        if($order->getPayment()->getMethod()=="elements") {
            $transaction = $method->updateTransaction($order);
            $artransaction=$this->transaction;
            $artransaction->setOrder($order);
            if (is_object($transaction)) {
                $artransaction->setTxnId($transaction->getTransactionId());
            }
            $artransaction->save();
            $amount = (double)$order->getBaseGrandTotal();
            $formattedAmount = $order->getBaseCurrency()->formatTxt($amount);
            $message = __('Authorized amount of %1.', $formattedAmount);
            $txnId = $artransaction->getTxnId();
    ...
    {
        $this->_eventManager->dispatch('ecc_ar_sales_order_grid_syn', ['order' => $this]);
     ...
     * @inheritdoc
     *
     * @return \Epicor\Customerconnect\Api\Data\OrderExtensionInterface|null
     */
     ...
     * @inheritdoc
     *
     * @param \Epicor\Customerconnect\Api\Data\OrderExtensionInterface $extensionAttributes
     * @return $this
     */
    public function setExtensionAttributes(\Epicor\Customerconnect\Api\Data\OrderExtensionInterface $extensionAttributes)
    {

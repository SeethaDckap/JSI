...
use Epicor\Customerconnect\Api\Data\TransactionInterface;
...
class Transaction extends AbstractModel implements TransactionInterface
{
     ...
     * Order instance
     *
     * @var \Epicor\Customerconnect\Model\ArPayment\Order\Payment
     */
    protected $_order = null;

    /**
     * Parent transaction instance
     * @var \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction
     */
     ...
     */
    protected $_eventPrefix = 'ecc_ar_sales_order_payment_transaction';
    ...
    /**
     * @var \Epicor\Customerconnect\Api\OrderPaymentRepositoryInterface
     */
     ...
     * @param \Epicor\Customerconnect\Model\ArPayment\OrderFactory $orderFactory
    ...
    public function __construct(
        ...
        \Epicor\Customerconnect\Api\OrderPaymentRepositoryInterface $orderPaymentRepository,
    ...
    {
        $this->_init(\Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\Transaction::class);
        parent::_construct();
    }
     ...
     * @return bool|\Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction
     */
     ...
     *
     * @param \Epicor\Customerconnect\Model\ArPayment\Order|null|boolean $order
     * @return $this
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    ...
    {
        return [
            \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction::TYPE_ORDER => __('Order'),
            \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction::TYPE_AUTH => __('Authorization'),
            \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction::TYPE_CAPTURE => __('Capture'),
            \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction::TYPE_VOID => __('Void'),
            \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction::TYPE_REFUND => __('Refund')
        ];
    }

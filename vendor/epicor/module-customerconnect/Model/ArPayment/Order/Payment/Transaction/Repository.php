...
use Epicor\Customerconnect\Api\OrderRepositoryInterface;
use Epicor\Customerconnect\Api\TransactionRepositoryInterface;
use Epicor\Customerconnect\Model\ArPayment\EntityStorage;
...
use Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\Transaction as TransactionResource;

/**
 * Repository class for \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction
...
class Repository implements TransactionRepositoryInterface
{
     ...
     * {@inheritdoc}
     */
    public function delete(\Epicor\Customerconnect\Api\Data\TransactionInterface $entity)
    {
     ...
     * {@inheritdoc}
     */
    public function save(\Epicor\Customerconnect\Api\Data\TransactionInterface $entity)
    {

 ...
 */
class Status extends \Epicor\Customerconnect\Model\ArPayment\AbstractModel
{
    /**
    ...
    {
        $this->_init(\Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Status::class);
    }
    ...
    {
        /** @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Status $resource */
    ...
    public function unassignState($state)
    {
        ...
        $this->_eventManager->dispatch(
            'ecc_ar_sales_order_status_unassign',
            [

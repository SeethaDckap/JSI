...
use Epicor\Customerconnect\Api\Data\CartExtensionInterface;
...
use Epicor\Customerconnect\Model\ArPayment\Quote\Address\ToOrder as ToOrderConverter;
use Epicor\Customerconnect\Model\ArPayment\Quote\Address\ToOrderAddress as ToOrderAddressConverter;
use Epicor\Customerconnect\Model\ArPayment\Quote\Item\ToOrderItem as ToOrderItemConverter;
use Epicor\Customerconnect\Model\ArPayment\Quote\Payment\ToOrderPayment as ToOrderPaymentConverter;
use Epicor\Customerconnect\Model\ArPayment\OrderFactory as OrderFactory;
 ...
 * @since 100.0.2
 */
class Quote extends AbstractExtensibleModel implements \Epicor\Customerconnect\Api\Data\CartInterface
{
    /**
     ...
     * @var string
     */
    protected $_eventPrefix = 'ar_sales_quote';
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\Quote\Payment
     */
     ...
     * Quote validator
     *
     * @var \Epicor\Customerconnect\Model\ArPayment\QuoteValidator
     */
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\Quote\AddressFactory
     */
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Item\CollectionFactory
     */
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\Quote\PaymentFactory
     */
    protected $_quotePaymentFactory;

    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Payment\CollectionFactory
     */
    ...
    /**
     * @var \Epicor\Customerconnect\Model\ArPayment\Quote\Item\Processor
     */
     ...
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Item\CollectionFactory $quoteItemCollectionFactory
     ...
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Payment\CollectionFactory $quotePaymentCollectionFactory
    ...
    public function __construct(
        ...
        \Epicor\Customerconnect\Model\ArPayment\QuoteValidator $quoteValidator,
        \Magento\Catalog\Helper\Product $catalogProduct,
        \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \Magento\Framework\App\Config\ScopeConfigInterface $config,
        \Epicor\Customerconnect\Model\ArPayment\Quote\AddressFactory $quoteAddressFactory,
        \Magento\Customer\Model\CustomerFactory $customerFactory,
        \Magento\Customer\Api\GroupRepositoryInterface $groupRepository,
        \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Item\CollectionFactory $quoteItemCollectionFactory,
        \Epicor\Customerconnect\Model\ArPayment\Quote\ItemFactory $quoteItemFactory,
        \Magento\Framework\Message\Factory $messageFactory,
        \Magento\Sales\Model\Status\ListFactory $statusListFactory,
        \Magento\Catalog\Api\ProductRepositoryInterface $productRepository,
        \Epicor\Customerconnect\Model\ArPayment\Quote\PaymentFactory $quotePaymentFactory,
        \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Payment\CollectionFactory $quotePaymentCollectionFactory,
        \Magento\Framework\DataObject\Copy $objectCopyService,
        \Magento\CatalogInventory\Api\StockRegistryInterface $stockRegistry,
        \Epicor\Customerconnect\Model\ArPayment\Quote\Item\Processor $itemProcessor,
        ...
        \Epicor\Customerconnect\Model\ArPayment\Cart\CurrencyFactory $currencyFactory,
    ...
    {
        $this->_init(\Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote::class);
    }
        ...
        if ($customer->getId()) {
            ...
            if (null !== $billingAddress) {
                ...
                if (isset($defaultBillingAddress)) {
                    /** @var \Epicor\Customerconnect\Model\ArPayment\Quote\Address $billingAddress */
            ...
            if (null === $shippingAddress) {
                ...
                if (isset($defaultShippingAddress)) {
                    /** @var \Epicor\Customerconnect\Model\ArPayment\Quote\Address $shippingAddress */
    ...
    {
        /** @var \Epicor\Customerconnect\Model\ArPayment\Quote\Address $address */
        foreach ($this->getAddressesCollection() as $address) {
            if (!$address->isDeleted() &&
    ...
    /**
     * @param \Epicor\Customerconnect\Api\Data\AddressInterface $address
     * @return $this
     */
    public function addAddress(\Epicor\Customerconnect\Api\Data\AddressInterface $address)
    {
        $address->setQuote($this);
        if (!$address->getId()) {
     ...
     * @return $this
     */
    public function setBillingAddress(\Epicor\Customerconnect\Api\Data\AddressInterface $address = null)
    {
     ...
     * @return $this
     */
    public function setShippingAddress(\Epicor\Customerconnect\Api\Data\AddressInterface $address = null)
    {
     ...
     * @return $this
     */
    public function addShippingAddress(\Epicor\Customerconnect\Api\Data\AddressInterface $address)
    {
    ...
    public function getAllItems()
    {
        ...
        foreach ($this->getItemsCollection() as $item) {
            /** @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Item $item */
            if (!$item->isDeleted()) {
                $items[] = $item;
            }
        }
     ...
     *
     * @param   int $itemId
     * @return  \Epicor\Customerconnect\Model\ArPayment\Quote\Item|false
     */
     ...
     *
     * @param   \Epicor\Customerconnect\Model\ArPayment\Quote\Item $item
     * @return $this
     */
    public function deleteItem(\Epicor\Customerconnect\Model\ArPayment\Quote\Item $item)
    {
        if ($item->getId()) {
            ...
            foreach ($quoteItems as $key => $quoteItem) {
                foreach ($items as $item) {
                    if ($quoteItem->compare($item)) {
                        $quoteItems->removeItemByKey($key)->save();
                    }
                }
            }
        }
    ...
    public function removeItem($itemId)
    {
        ...
        if ($item) {
            ...
            $this->_eventManager->dispatch('ar_sales_quote_remove_item', ['quote_item' => $item]);
        }
     ...
     */
    public function addItem(\Epicor\Customerconnect\Model\ArPayment\Quote\Item $item)
    {
        $item->setQuote($this);
        if (!$item->getId()) {
            $this->getItemsCollection()->addItem($item)->save();
            $this->_eventManager->dispatch('ar_sales_quote_add_item', ['quote_item' => $item]);
        }
        return $this;
    }
    public function addArItem(\Epicor\Customerconnect\Model\ArPayment\Quote\Item $item)
    {
        $item->setQuote($this);
        if (!$item->getId()) {
            $this->getItemsCollection()->addItem($item)->save();
     ...
     * @return \Epicor\Customerconnect\Model\ArPayment\Quote\Item|string
     * @throws \Magento\Framework\Exception\LocalizedException
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     * @SuppressWarnings(PHPMD.NPathComplexity)
     */

    public function addMultiInvoice(
        $requests = []
    ) {
        foreach ($this->getAllItems() as $item) {
           $item->delete();
    ...
    public function addInvoice(
       ...
       $newItem = false;
        $item = $this->getItemByInvoice($sku);
        if (!$item) {
        ...
        if($request){
            ...
            $item->setRowTotal($request['price']);
        }
        $item->setAdditionalData($request['additional_data']);
        $item->save();
        return $item;
    }
    public function addProduct(
        ...
        $this->_eventManager->dispatch('ar_sales_quote_product_add_after', ['items' => $items]);
        return $parentItem;
    }
     ...
     *
     * @param   \Magento\Catalog\Model\Product $product
     * @return  \Epicor\Customerconnect\Model\ArPayment\Quote\Item|bool
     */
    ...
    public function getItemByInvoice($sku)
    {
    ...
    /**
     * @return \Epicor\Customerconnect\Model\ArPayment\Quote\Payment
     */
     ...
     * @return $this
     */
    protected function addPayment($payment)
    {
        $payment->setQuote($this);
        if (!$payment->getId()) {
    ...
    public function collectTotals()
    {
        ...
        $this->setbaseGrandTotal($grandTotal);
        return $this;
    }
        ...
        if (!$minOrderMulti) {
            foreach ($addresses as $address) {
                ...
                foreach ($address->getQuote()->getItemsCollection() as $item) {
                    /** @var \Epicor\Customerconnect\Model\ArPayment\Quote\Item $item */
    ...
    public function isVirtual()
    {
        ...
        foreach ($this->getItemsCollection() as $_item) {
            /* @var $_item \Epicor\Customerconnect\Model\ArPayment\Quote\Item */
    ...
    public function submitQuote(Quote $quote, $orderData = [])
    {
      ...
      //  $order->setShippingMethod($quote->getShippingAddress()->getShippingMethod());
        ...
        //Custom Fields for Ar payments
        $billingAddress->setData('ecc_mobile_number', $quote->getBillingAddress()->getData('ecc_mobile_number'));
        ...
        //Custom Fields for Ar payments
        $order->setData('ecc_arpayments_allocated_amount', $quote->getData('ecc_arpayments_allocated_amount'));
        $order->setData('ecc_arpayments_amountleft', $quote->getData('ecc_arpayments_amountleft'));
        $order->setData('ecc_arpayments_ispayment', $quote->getData('ecc_arpayments_ispayment'));

        $order->setData('grand_total', $quote->getData('grand_total'));
        $order->setData('base_grand_total', $quote->getData('base_grand_total'));
     ...
     * @return array
     */
    protected function resolveItems(Quote $quote)
    {
        $orderItems = [];
        foreach ($quote->getAllItems() as $quoteItem) {
            ...
            /** @var \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Item $parentItem */
    ...
    public function setExtensionAttributes(\Epicor\Customerconnect\Api\Data\CartExtensionInterface $extensionAttributes)
    {

...
class Address extends \Magento\Customer\Model\Address\AbstractAddress implements
    \Epicor\Customerconnect\Api\Data\AddressInterface
{
    const RATES_FETCH = 1;
     ...
     * @var string
     */
    protected $_eventPrefix = 'ar_sales_quote_address';
     ...
     *
     * @var \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Rate
     */
    protected $_rates;
     ...
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Address\Item\CollectionFactory $itemCollectionFactory
     * @param \Epicor\Customerconnect\Model\ArPayment\Quote\Address\RateFactory $addressRateFactory
     * @param Address\RateCollectorInterfaceFactory $rateCollector
     * @param \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Address\Rate\CollectionFactory $rateCollectionFactory
     ...
     * @param \Epicor\Customerconnect\Model\ArPayment\Quote\TotalsReader $totalsReader
    ...
    {
        $this->_init(\Epicor\Customerconnect\Model\ArPayment\ResourceModel\Quote\Address::class);
    }
    ...
    {
        return $this->getAddressType() == \Epicor\Customerconnect\Model\ArPayment\Quote\Address::TYPE_SHIPPING &&
     ...
     *
     * @return \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Item[]
     ...
     *
     * @param int $itemId
     * @return \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Item|false
     */
     ...
     * Add item to address
     *
     * @param \Epicor\Customerconnect\Model\ArPayment\Quote\Item\AbstractItem $item
     * @param int $qty
     * @return $this
     */
    public function addItem(\Epicor\Customerconnect\Model\ArPayment\Quote\Item\AbstractItem $item, $qty = null)
    {
        if ($item instanceof \Epicor\Customerconnect\Model\ArPayment\Quote\Item) {
            if ($item->getParentItemId()) {
                return $this;
            }
     ...
     *
     * @param   int $rateId
     * @return  \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Rate|false
     */
     ...
     * Add shipping rate
     *
     * @param \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Rate $rate
     * @return $this
     */
    public function addShippingRate(\Epicor\Customerconnect\Model\ArPayment\Quote\Address\Rate $rate)
    {
        $rate->setAddress($this);
     ...
     * @SuppressWarnings(PHPMD.NPathComplexity)
     */
    public function requestShippingRates(\Epicor\Customerconnect\Model\ArPayment\Quote\Item\AbstractItem $item = null)
    {
        /** @var $request \Epicor\Customerconnect\Model\ArPayment\Quote\Address\RateRequest */
     ...
     *
     * @param \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Total|array $total
     * @return $this
     */
    public function addTotal($total)
    {
        $addressTotal = null;
        if (is_array($total)) {
            /** @var \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Total $addressTotal */
            $addressTotal = $this->_addressTotalFactory->create(\Epicor\Customerconnect\Model\ArPayment\Quote\Address\Total::class);
            $addressTotal->setData($total);
        } elseif ($total instanceof \Epicor\Customerconnect\Model\ArPayment\Quote\Address\Total) {
            $addressTotal = $total;
        }

 ...
 */
namespace Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Item;
...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'ecc_ar_sales_order_item_collection';
    ...
    {
        $this->_init(\Epicor\Customerconnect\Model\ArPayment\Order\Item::class, \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Item::class);
    }
    ...
    public function addIdFilter($item)
    {
        ...
        } elseif ($item instanceof \Epicor\Customerconnect\Model\ArPayment\Order\Item) {

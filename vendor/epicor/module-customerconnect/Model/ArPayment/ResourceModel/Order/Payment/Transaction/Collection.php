 ...
 */
namespace Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\Transaction;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Epicor\Customerconnect\Model\ArPayment\Order\Payment\Transaction::class,
            \Epicor\Customerconnect\Model\ArPayment\ResourceModel\Order\Payment\Transaction::class
        );
     ...
     *
     * @param \Epicor\Customerconnect\Model\ArPayment\Order\Payment|int $payment
     * @return $this
     */
    ...
    protected function _renderFiltersBefore()
    {
        ...
        if ($this->_addPaymentInformation) {
            $this->getSelect()->joinInner(
                ['sop' => $this->getTable('ecc_ar_sales_order_payment')],

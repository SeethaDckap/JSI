define([
        ...
        return {
            ...
            showPopup: function (entity_document = null) {
                ...
                var msgEl = $('#email-doc-popup-form textarea[name="email-msg"]');
                var subEl =  $('#email-doc-popup-form input[name="email-subject"]');
            ...
            closePopup: function () {
                $('.email-doc-popup').modal('closeModal');
            },

 ...
 */
namespace Epicor\Dealerconnect\Block\Adminhtml\Advanced\Cleardata\Clear;


/**
 * Epicor_Dealerconnect_Block_Adminhtml_Advanced_Cleardata
 * 
 * Form for Clear Data
 * 
 * @category   Epicor
 ...
 */
class Form extends \Epicor\Common\Block\Adminhtml\Advanced\Cleardata\Clear\Form
{
    ...
    {   
        ...
        $fieldset->addField('pac', 'checkbox', array(
            'label' => __('Pac'),
            'name' => 'pac',
            'value' => '1',
            'tabindex' => 9

 ...
 */
namespace Epicor\Dealerconnect\Block\Adminhtml\Config\Form\Field\Debm\Orig;
    ...
    public function _toHtml()
    {
        ...
        $html .= '
            <style>
                ...
                #grid_orig_debm table th:nth-child(11){ display:none;} 
                 #grid_orig_debm table th:nth-child(12){ display:none;} 
                //#grid_orig_debm table td:nth-child(12){ display:none;} 
                #grid_orig_debm table td:nth-child(11){ display:none;}      
                #grid_orig_debm table td:nth-child(12){ display:none;}      
                #grid_orig_debm table th:nth-child(8){ display:none;} 
                #grid_orig_debm table td:nth-child(8){ display:none;}      
               // #grid_orig_debm {width:700px;overflow-x:scroll;overflow-y:scroll;} 
                .altdebm {} 
                #grid_orig_debm table.admin__control-table .altdebm td {  }
                #grid_orig_debm table.admin__control-table td { background-color:transparent ;  }
                #grid_orig_debm table.admin__control-table { background-color: #f2f2f2; }
                #grid_orig_debm table.admin__control-table th { background-color:#5f564f; color:#fff; }
                #grid_orig_debm select {
                    font-size: 13px;
                }   
                #grid_orig_debm tbody tr:hover {

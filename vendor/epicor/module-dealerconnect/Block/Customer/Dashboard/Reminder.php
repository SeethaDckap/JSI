...
class Reminder extends \Magento\Framework\View\Element\Template
{
    ...
    public function getClaimsData()
    {
        ...
        $rfqsRemainderFactor = $this->dealerReminderFactory->create();
        $result = $rfqsRemainderFactor->loadcurrentData(
            [
                'customer_id' => $customer->getId(),
                'account_id' => $customer->getEccErpaccountId()
            ]
        );
        //echo '<pre>'; print_r($rfqsRemainderFactor->getCustomerErpAccounts());
        return $result;
    }
    ...
    {
        return $this->getUrl('dealerconnect/dashboard/remindersave');
    }

...
class Search extends \Epicor\Dealerconnect\Block\Portal\Inventory\BillOfMaterials\Generic\Listing\Grid
{
    ...
    protected $_configLocation = 'grid_config_built';
    ...
    protected function initColumns()
    {
        ...
        foreach ($columnConfig as $column) {
            ...
            if($column['index'] == 'serial_numbers_serial_number'){
                $column['renderer'] = '\Epicor\Dealerconnect\Block\Portal\Inventory\BillOfMaterials\Generic\Renderer\Serialnumber';
            }elseif($column['index'] == 'expand'){
                $column['renderer'] = '\Epicor\Dealerconnect\Block\Portal\Inventory\BillOfMaterials\Generic\Renderer\Expand';
                $column['header'] = '';
                $column['filter'] = false; 
                $column['sortable'] = false;
            }elseif($column['index'] == 'reorder'){
    ...
    {
        return $this->dealerHelper->checkBomOrigReplace();
    }
}

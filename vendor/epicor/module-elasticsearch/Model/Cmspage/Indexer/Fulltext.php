...
namespace Epicor\Elasticsearch\Model\Cmspage\Indexer;

use Magento\Framework\Search\Request\DimensionFactory;
use Magento\Store\Model\StoreManagerInterface;
use Magento\Framework\Indexer\ActionInterface;
use Magento\Framework\Mview\ActionInterface as MviewActionInterface;
use Epicor\Elasticsearch\Model\Cmspage\Indexer\Fulltext\Action\Full;
use Epicor\Elasticsearch\Model\Cmspage\Indexer\IndexerHandlerFactory;
use Magento\Elasticsearch\Model\Config;

/**
 * CMS Page fulltext indexer
 * @package Epicor\Elasticsearch\Model\Cmspage\Indexer
 */
class Fulltext implements ActionInterface, MviewActionInterface
{
    const INDEXER_ID = 'ecc_cms_pages_fulltext';

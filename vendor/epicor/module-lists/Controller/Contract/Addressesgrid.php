...
class Addressesgrid extends \Epicor\Lists\Controller\Lists
{
    ...
    public function execute() {
        ...
        $output = $this->getLayoutFactory()->create()->createBlock('Epicor\Lists\Block\Contract\Addresses\Grid')->toHtml();

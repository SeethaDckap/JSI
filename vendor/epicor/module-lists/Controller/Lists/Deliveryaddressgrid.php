...
class Deliveryaddressgrid extends \Epicor\Lists\Controller\Lists
{
    /**
    ...
    {        
        $output = $this->getLayoutFactory()->create()->createBlock('Epicor\Lists\Block\Customer\Account\Deliveryaddress\Grid')->toHtml();

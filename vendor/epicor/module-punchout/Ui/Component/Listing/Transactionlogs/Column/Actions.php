...
namespace Epicor\Punchout\Ui\Component\Listing\Transactionlogs\Column;
...
{
    const URL_PATH_EDIT    = 'epicor_punchout/transactionlogs/view';
    const URL_PATH_DELETE  = 'epicor_punchout/transactionlogs/delete';

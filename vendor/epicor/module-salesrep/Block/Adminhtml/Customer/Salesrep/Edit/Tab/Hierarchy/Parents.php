...
class Parents extends \Magento\Backend\Block\Widget\Grid\Extended  implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function getSelected()
    {
        if (empty($this->_selected) && $this->getRequest()->getParam('ajax') !== 'true') {
            ...
            $collection = $this->salesRepResourceHierarchyCollectionFactory->create()->addFieldToFilter('child_sales_rep_account_id', $this->getSalesRepAccount()->getId());
                ...
                require([
                    ...
                    //<![CDATA[
                        $(document).ready(function() {
                           jQuery("#childrenGrid").before(\'<div class="fieldset-wrapper-title"><strong class="title"><span>Children</span></strong></div>\');
                    //]]>
                    })
                }) 
                </script>';

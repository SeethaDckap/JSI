...
class Options extends \Magento\Framework\View\Element\Html\Select
{
    ...
    public function _toHtml()
    {
        if (!$this->getOptions()) {
            ...
            $this->addOption('supplierconnect/config_source_rfqstatusoptions', __('Rfq Status'));
            $this->addOption('supplierconnect/config_source_rfqresponseoptions', __('Rfq Response'));
        }

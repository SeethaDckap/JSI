...
//            $attribute->setFrontendLabel($this->__($attribute->getFrontend()->getLabel()));
...
//                    'password_fieldset',
//                    array('legend' => $this->__('Password Management'))
//                );
...
//                        'name'  => 'confirmation',
//                        'label' => $this->__($confirmationAttribute->getFrontendLabel()),
...
//                            'name'  => 'sendemail',
//                            'label' => $this->__('Send Welcome Email after Confirmation')
//                        ));
...
//            $fieldset->addField('sendemail', 'checkbox', array(
//                'label' => $this->__('Send Welcome Email'),
//                'name'  => 'sendemail',
//                'id'    => 'sendemail',
//            ));
//            $customer->setData('sendemail', '1');

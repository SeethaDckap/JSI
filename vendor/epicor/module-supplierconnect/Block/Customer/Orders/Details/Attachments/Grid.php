...
namespace Epicor\Supplierconnect\Block\Customer\Orders\Details\Attachments;
...
class Grid extends \Epicor\Common\Block\Generic\Listing\Grid
{
    ...
    public function __construct(
        ...
        $this->setId('supplier_orders_attachments');
        ...
        if ($order) {
            $attData     = ($order->getPurchaseOrder()->getAttachments()) ? $order->getPurchaseOrder()->getAttachments()->getasarrayAttachment() : array();
            $attachments = [];
    ...
    protected function _getColumns()
    {
        ...
        $columns['delete'] = [
            ...
            'type'     => 'text',
            'width'    => '50px',
            'renderer' => 'Epicor\Supplierconnect\Block\Customer\Orders\Details\Attachments\Renderer\Delete',
            'filter'   => false,
        ];
        ...
        $columns['description'] = [
            ...
            'index'    => 'description',
            'type'     => 'text',
            'renderer' => 'Epicor\Supplierconnect\Block\Customer\Orders\Details\Attachments\Renderer\Description',
            'filter'   => false,
        ];
        ...
        $columns['filename'] = [
            ...
            'index'    => 'filename',
            'type'     => 'text',
            'renderer' => 'Epicor\Supplierconnect\Block\Customer\Orders\Details\Attachments\Renderer\Filename',
            'filter'   => false,
        ];
        return $columns;

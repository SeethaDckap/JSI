 ...
 */
namespace Epicor\Supplierconnect\Block\Customer\Rfqs\Listing;
...
class Grid extends \Epicor\Common\Block\Generic\Listing\SearchArray
{
    ...
    public function getRowUrl($row)
    {
        ...
        if ($this->isRowUrlAllowed()) {
            ...
            $enabled = $msgHelper->isMessageEnabled('supplierconnect', 'surd');

            if ($enabled && $accessHelper->customerHasAccess('Epicor_Supplierconnect', 'Rfq', 'details', '', 'Access')) {
                ...
                $url = $this->getUrl('*/*/details', array('rfq' => $rfq_requested));
            }
        }
        return $url;
    }

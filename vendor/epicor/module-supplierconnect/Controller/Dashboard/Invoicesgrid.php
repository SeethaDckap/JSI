...
class Invoicesgrid extends \Epicor\Supplierconnect\Controller\Dashboard
{
    ...
    {
        $output = $this->getLayoutFactory()->create()->createBlock('Epicor\Supplierconnect\Block\Customer\Dashboard\Invoicesgrid')->toHtml();

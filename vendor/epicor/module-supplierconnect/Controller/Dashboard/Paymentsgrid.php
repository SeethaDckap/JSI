...
class Paymentsgrid extends \Epicor\Supplierconnect\Controller\Dashboard
{
    ...
    {
        $output = $this->getLayoutFactory()->create()->createBlock('Epicor\Supplierconnect\Block\Customer\Dashboard\Paymentsgrid')->toHtml();
